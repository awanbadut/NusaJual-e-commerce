...
<body class="bg-[#F8FCF8] font-sans text-gray-800" x-data="{ sidebarOpen: false }">
    <div class="flex flex-col h-screen overflow-hidden">
        ...
        {{-- ====== NAVBAR ====== --}}
        <nav class="bg-white border-b border-gray-200 h-16 flex items-center px-4 sm:px-6 sticky top-0 z-30 flex-shrink-0 shadow-sm">
            <div class="flex justify-between items-center w-full">
                ...
                <a href="{{ route('admin.profile.index') }}"
                    ...
                    <div class="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-green-800 text-white flex items-center justify-center font-semibold text-sm">
        ...
        <div class="flex flex-1 overflow-hidden relative">
            ...
            <aside
                ...
                <div class="flex items-center justify-between px-4 h-16 border-b border-gray-200 lg:hidden flex-shrink-0">
                ...
                <div class="p-3 space-y-1 flex-1 overflow-y-auto">
                    ...
                    <div x-data="{ open: {{ request()->routeIs('admin.mitra.*') ? 'true' : 'false' }} }">
                        ...
                        <div x-show="open" x-collapse class="mt-1 ml-4 space-y-1">
                            ...
                            <a href="{{ route('admin.mitra.show', $store->id) }}"
                                class="block px-3 py-2 rounded-lg text-xs border-l-2 truncate
                            ...
                            <button type="button"
                                ...
                                class="w-full text-left px-3 py-2 rounded-lg text-xs text-blue-600 hover:bg-blue-50 font-medium">
                                Lihat semua mitra…
                            </button>
                            @endif
                        </div>
                    ...
                    <a href="{{ route('admin.categories.index') }}"
                        class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition
                               {{ request()->routeIs('admin.categories.*') ? 'bg-green-800 text-white' : 'text-gray-700 hover:bg-gray-50' }}">
