                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="relative">
                        ...
                        <div id="userDropdown" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
                            ...
                            <a href="{{ route('seller.profile') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                                Profile Toko
                            </a>
        ...
        <div class="flex flex-1 overflow-hidden">
            ...
            <aside class="w-56 bg-white border-r border-gray-200 overflow-y-auto flex-shrink-0">
                ...
                <nav class="p-3 space-y-1">
                    ...
                    <form action="{{ route('seller.logout') }}" method="POST">
                        @csrf
                        <button type="submit" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-red-600 hover:bg-red-50 w-full text-left transition">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
