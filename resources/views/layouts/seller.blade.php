    ...
    <div class="flex flex-col h-screen overflow-hidden">
        ...
        <header
            ...
            <div class="flex items-center justify-between w-full">
                ...
                <div class="flex items-center gap-2 sm:gap-3 w-auto lg:w-56 transition-all duration-300">
                    <button id="sidebarToggle"
                        class="lg:hidden p-1.5 rounded-md text-gray-600 hover:bg-gray-100 focus:outline-none">
