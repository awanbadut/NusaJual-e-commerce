...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Kelola Pencairan Dana</h1>
            <p class="text-sm text-gray-600 mt-1">Proses permintaan pencairan dana dari mitra</p>
        </div>
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 border-b">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left font-semibold text-gray-700">Nama Toko</th>
                        ...
                        <th class="px-4 py-3 text-left font-semibold text-gray-700">Diterima Mitra</th>
