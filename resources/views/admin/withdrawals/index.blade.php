    ...
    <div class="bg-white p-6 rounded-xl shadow-sm border mb-6">
        ...
        <div class="mb-4 flex items-center gap-2 text-sm">
            ...
            <div class="flex flex-wrap gap-2">
                @if(request('status'))
                <span
                    class="inline-flex items-center gap-1 px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-semibold">
            ...
            <table class="w-full text-[13px]">
                ...
                <tbody>
                    ...
                    <tr class="border-b hover:bg-gray-50 transition">
                        <td class="px-5 py-4 font-mono text-xs">#WD-{{ str_pad($withdrawal->id, 4, '0', STR_PAD_LEFT) }}
                        </td>
                        <td class="px-5 py-4">
                        ...
                        <td class="px-5 py-4 font-semibold">Rp {{ number_format($withdrawal->amount, 0, ',', '.') }}
                        </td>
                        <td class="px-5 py-4 text-red-600 font-semibold">Rp {{ number_format($withdrawal->admin_fee, 0,
                            ',', '.') }}</td>
                        <td class="px-5 py-4 font-bold text-green-600">Rp {{ number_format($withdrawal->total_received,
                            0, ',', '.') }}</td>
                        <td class="px-5 py-4">
                        ...
                        <td class="px-5 py-4">
                            <div class="flex gap-2">
                                <a href="{{ route('admin.withdrawals.show', $withdrawal->id) }}"
                                    class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-[#15803D] hover:bg-[#166534] transition text-white focus:outline-none focus:ring-0 border-none"
                                    title="Lihat Detail">
