...
<div class="max-w-7xl">
    ...
    <div class="mb-6 flex items-center gap-4">
        ...
        <div>
            ...
            <h1 class="text-3xl font-bold text-green-800">Detail Pelanggan <span class="text-gray-900">{{ $customer->name }}</span></h1>
        </div>
    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-900">{{ $customer->date_of_birth ? date('d M Y', strtotime($customer->date_of_birth)) : '-' }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                <table class="w-full">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase">Total Belanja</th>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-700">{{ date('d/m/y', strtotime($order->created_at)) }}</td>
                            <td class="px-6 py-4">
                                @if($order->status == 'completed')
                                    <span class="px-3 py-1 rounded-full text-xs font-semibold bg-green-600 text-white">Selesai</span>
                                @elseif($order->status == 'pending')
                                    <span class="px-3 py-1 rounded-full text-xs font-semibold bg-yellow-600 text-white">Menunggu Pembayaran</span>
                ...
                <div class="px-6 py-4 border-t">
                    <p class="text-sm text-gray-600">
                        Menampilkan <span class="font-medium">1</span> sampai <span class="font-medium">{{ $customer->orders->count() }}</span> dari <span class="font-medium">{{ $totalOrders }}</span> data
                    </p>
                </div>
                @endif
            </div>
