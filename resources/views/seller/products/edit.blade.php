                    ...
                    <div class="mb-4">
                        ...
                        <div class="grid grid-cols-4 gap-2" id="existingImages">
                            ...
                            <div class="relative group image-item" data-image-id="{{ $image->id }}">
                                ...
                                @if($image->is_primary)
                                <span class="absolute top-1 left-1 bg-green-600 text-white text-xs px-1.5 py-0.5 rounded text-[10px]">Primary</span>
                                @endif
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select 
                                ...
                                <option value="Gr" {{ old('unit', $product->unit) == 'Gr' ? 'selected' : '' }}>Gr</option>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    ...
                                    class="w-full pl-12 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-transparent text-sm" 
                                    min="0"
                                    required>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-transparent text-sm" 
                                min="0"
                                required>
                        </div>
                    </div>
